...
/**
 * IssuesInput Class Doc Comment
 *
 * @category Class
 * @package  Carbon
 * @implements \ArrayAccess<string, mixed>
 */
class IssuesInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IssuesInput';
    ...
    protected static $openAPITypes = [
        ...
        'page_size' => 'int',
        'next_cursor' => 'string',
        'filters' => '\Carbon\Model\IssuesFilter',
        'order_by' => '\Carbon\Model\IssuesOrderBy',
    ...
    */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling IssuesInput., must be smaller than or equal to 100.');
        }
     ...
     * Gets filters
     *
     * @return \Carbon\Model\IssuesFilter|null
     */
     ...
     * Sets filters
     *
     * @param \Carbon\Model\IssuesFilter|null $filters filters
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \Carbon\Model\IssuesOrderBy|null
     */
     ...
     * Sets order_by
     *
     * @param \Carbon\Model\IssuesOrderBy|null $order_by order_by
     *
     * @return self
     */
