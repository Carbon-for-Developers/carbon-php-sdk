...
/**
 * PullRequestsInput Class Doc Comment
 *
 * @category Class
 * @package  Carbon
 * @implements \ArrayAccess<string, mixed>
 */
class PullRequestsInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PullRequestsInput';
    ...
    protected static $openAPITypes = [
        ...
        'page_size' => 'int',
        'next_cursor' => 'string',
        'filters' => '\Carbon\Model\PullRequestFilters',
        'order_by' => '\Carbon\Model\PROrderBy',
    ...
    */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling PullRequestsInput., must be smaller than or equal to 100.');
        }
     ...
     * Gets filters
     *
     * @return \Carbon\Model\PullRequestFilters|null
     */
     ...
     * Sets filters
     *
     * @param \Carbon\Model\PullRequestFilters|null $filters filters
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \Carbon\Model\PROrderBy|null
     */
     ...
     * Sets order_by
     *
     * @param \Carbon\Model\PROrderBy|null $order_by order_by
     *
     * @return self
     */
