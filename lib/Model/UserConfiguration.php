    ...
    */
    ...
    public function setMaxFiles($max_files)
    {
        ...
        if (!is_null($max_files) && ($max_files < -1)) {
            throw new \InvalidArgumentException('invalid value for $max_files when calling UserConfiguration., must be bigger than or equal to -1.');
        }
    ...
    public function setMaxFilesPerUpload($max_files_per_upload)
    {
        ...
        if (!is_null($max_files_per_upload) && ($max_files_per_upload < -1)) {
            throw new \InvalidArgumentException('invalid value for $max_files_per_upload when calling UserConfiguration., must be bigger than or equal to -1.');
        }
    ...
    public function setMaxCharacters($max_characters)
    {
        ...
        if (!is_null($max_characters) && ($max_characters < -1)) {
            throw new \InvalidArgumentException('invalid value for $max_characters when calling UserConfiguration., must be bigger than or equal to -1.');
        }
    ...
    public function setMaxCharactersPerFile($max_characters_per_file)
    {
        ...
        if (!is_null($max_characters_per_file) && ($max_characters_per_file < -1)) {
            throw new \InvalidArgumentException('invalid value for $max_characters_per_file when calling UserConfiguration., must be bigger than or equal to -1.');
        }
    ...
    public function setMaxCharactersPerUpload($max_characters_per_upload)
    {
        ...
        if (!is_null($max_characters_per_upload) && ($max_characters_per_upload < -1)) {
            throw new \InvalidArgumentException('invalid value for $max_characters_per_upload when calling UserConfiguration., must be bigger than or equal to -1.');
        }
    ...
    public function setAutoSyncInterval($auto_sync_interval)
    {
        ...
        if (!is_null($auto_sync_interval) && ($auto_sync_interval < -1)) {
            throw new \InvalidArgumentException('invalid value for $auto_sync_interval when calling UserConfiguration., must be bigger than or equal to -1.');
        }
