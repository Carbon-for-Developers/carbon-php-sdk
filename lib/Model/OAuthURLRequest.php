...
class OAuthURLRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets use_ocr
     *
     * @param bool|null $use_ocr Enable OCR for files that support it. Supported formats: png, pdf, jpg
     *
     * @return self
     */
     ...
     *
     * @param bool|null $enable_file_picker Enable integration's file picker for sources that support it. Supported sources: BOX, DROPBOX, GOOGLE_DRIVE, ONEDRIVE, SHAREPOINT
     *
     * @return self
     */
