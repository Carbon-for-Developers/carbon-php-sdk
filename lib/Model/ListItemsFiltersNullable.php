    ...
    */
    ...
    public function setFileFormats($file_formats)
    {
        ...
        if (!is_null($file_formats) && (count($file_formats) > 50)) {
            throw new \InvalidArgumentException('invalid value for $file_formats when calling ListItemsFiltersNullable., number of items must be less than or equal to 50.');
        }
    ...
    public function setItemTypes($item_types)
    {
        ...
        if (!is_null($item_types) && (count($item_types) > 50)) {
            throw new \InvalidArgumentException('invalid value for $item_types when calling ListItemsFiltersNullable., number of items must be less than or equal to 50.');
        }
