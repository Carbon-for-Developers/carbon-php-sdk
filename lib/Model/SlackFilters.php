...
/**
 * SlackFilters Class Doc Comment
 *
 * @category Class
 * @package  Carbon
 * @implements \ArrayAccess<string, mixed>
 */
class SlackFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SlackFilters';
    ...
    */
     ...
     *
     * @param string $conversation_id Conversation ID from slack, can be obtained from Carbon with slack conversations endpoint
     *
     * @return self
     */
     ...
     * Sets after
     *
     * @param string|null $after Only messages after this date will be included in results. If not set, all messages          will be included. Should be entered in YYYY/mm/dd format
     *
     * @return self
     */
