...
/**
 * Document360ConnectRequest Class Doc Comment
 *
 * @category Class
 * @package  Carbon
 * @implements \ArrayAccess<string, mixed>
 */
class Document360ConnectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Document360ConnectRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['account_email'] === null) {
            $invalidProperties[] = "'account_email' can't be null";
        }
     ...
     * Sets account_email
     *
     * @param string $account_email This email will be used to identify your carbon data source. It should have access to the          Document360 account you wish to connect.
     *
     * @return self
     */
