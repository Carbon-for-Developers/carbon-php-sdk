...
/**
     ...
     * Connect Data Source
     *
     * @param  \Carbon\Model\ConnectDataSourceInput $connect_data_source_input connect_data_source_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectDataSource'] to see the possible values for this operation
     *
     * @throws \Carbon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Carbon\Model\ConnectDataSourceResponse|\Carbon\Model\HTTPValidationError
     */
    public function connectDataSource(

        $authentication,
        $sync_options = SENTINEL_VALUE,
        string $contentType = self::contentTypes['connectDataSource'][0]
    )
    {
        $_body = [];
        $this->setRequestBodyProperty($_body, "authentication", $authentication);
        $this->setRequestBodyProperty($_body, "sync_options", $sync_options);
        $connect_data_source_input = $_body;

        list($response) = $this->connectDataSourceWithHttpInfo($connect_data_source_input, $contentType);
        return $response;
    }

    /**
     * Operation connectDataSourceWithHttpInfo
     *
     * Connect Data Source
     *
     * @param  \Carbon\Model\ConnectDataSourceInput $connect_data_source_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectDataSource'] to see the possible values for this operation
     *
     * @throws \Carbon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Carbon\Model\ConnectDataSourceResponse|\Carbon\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function connectDataSourceWithHttpInfo($connect_data_source_input, string $contentType = self::contentTypes['connectDataSource'][0], \Carbon\RequestOptions $requestOptions = new \Carbon\RequestOptions())
    {
        ["request" => $request, "serializedBody" => $serializedBody] = $this->connectDataSourceRequest($connect_data_source_input, $contentType);
        ...
        try {
            ...
            try {
                ...
                if (
                    ...
                    return $this->connectDataSourceWithHttpInfo(
                        $connect_data_source_input,
                        $contentType,
                        $requestOptions->setRetryOAuth(false)
                    );
                }
            ...
            switch($statusCode) {
                case 200:
                    if ('\Carbon\Model\ConnectDataSourceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Carbon\Model\ConnectDataSourceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Carbon\Model\ConnectDataSourceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\Carbon\Model\ConnectDataSourceResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Carbon\Model\ConnectDataSourceResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation connectDataSourceAsync
     *
     * Connect Data Source
     *
     * @param  \Carbon\Model\ConnectDataSourceInput $connect_data_source_input (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function connectDataSourceAsync(
    ...
    )
    {
        ...
        return $this->connectDataSourceAsyncWithHttpInfo($connect_data_source_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation connectDataSourceAsyncWithHttpInfo
     *
     * Connect Data Source
     *
     * @param  \Carbon\Model\ConnectDataSourceInput $connect_data_source_input (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function connectDataSourceAsyncWithHttpInfo($connect_data_source_input, string $contentType = self::contentTypes['connectDataSource'][0], \Carbon\RequestOptions $requestOptions = new \Carbon\RequestOptions())
    {
        $returnType = '\Carbon\Model\ConnectDataSourceResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->connectDataSourceRequest($connect_data_source_input, $contentType);
    ...
    /**
     * Create request for operation 'connectDataSource'
     *
     * @param  \Carbon\Model\ConnectDataSourceInput $connect_data_source_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectDataSource'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function connectDataSourceRequest($connect_data_source_input, string $contentType = self::contentTypes['connectDataSource'][0])
    {

        if ($connect_data_source_input !== SENTINEL_VALUE) {
            if (!($connect_data_source_input instanceof \Carbon\Model\ConnectDataSourceInput)) {
                if (!is_array($connect_data_source_input))
                    throw new \InvalidArgumentException('"connect_data_source_input" must be associative array or an instance of \Carbon\Model\ConnectDataSourceInput IntegrationsApi.connectDataSource.');
                else
                    $connect_data_source_input = new \Carbon\Model\ConnectDataSourceInput($connect_data_source_input);
            }
        }
        // verify the required parameter 'connect_data_source_input' is set
        if ($connect_data_source_input === SENTINEL_VALUE || (is_array($connect_data_source_input) && count($connect_data_source_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter connect_data_source_input when calling connectDataSource'
            );
        }


        $resourcePath = '/integrations/connect';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($connect_data_source_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
     ...
     *
     * @param  \Carbon\Model\GuruConnectRequest $guru_connect_request guru_connect_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectGuru'] to see the possible values for this operation
     *
     * @throws \Carbon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Carbon\Model\GenericSuccessResponse|\Carbon\Model\HTTPValidationError
     */
    public function connectGuru(
    ...
    /**
     * Operation connectGuruWithHttpInfo
     *
     * Guru Connect
     *
     * You will need an access token to connect your Guru account. To obtain an access token, follow the steps highlighted here https://help.getguru.com/docs/gurus-api#obtaining-a-user-token. The username should be your Guru username.
     *
     * @param  \Carbon\Model\GuruConnectRequest $guru_connect_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectGuru'] to see the possible values for this operation
     *
     * @throws \Carbon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Carbon\Model\GenericSuccessResponse|\Carbon\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function connectGuruWithHttpInfo($guru_connect_request, string $contentType = self::contentTypes['connectGuru'][0], \Carbon\RequestOptions $requestOptions = new \Carbon\RequestOptions())
    {
        ["request" => $request, "serializedBody" => $serializedBody] = $this->connectGuruRequest($guru_connect_request, $contentType);
        ...
        try {
            ...
            try {
                ...
                if (
                    ...
                    return $this->connectGuruWithHttpInfo(
                        $guru_connect_request,
                        $contentType,
                        $requestOptions->setRetryOAuth(false)
                    );
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function connectGuruAsync(
    ...
    /**
     * Operation connectGuruAsyncWithHttpInfo
     *
     * Guru Connect
     *
     * You will need an access token to connect your Guru account. To obtain an access token, follow the steps highlighted here https://help.getguru.com/docs/gurus-api#obtaining-a-user-token. The username should be your Guru username.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function connectGuruAsyncWithHttpInfo($guru_connect_request, string $contentType = self::contentTypes['connectGuru'][0], \Carbon\RequestOptions $requestOptions = new \Carbon\RequestOptions())
    {
        $returnType = '\Carbon\Model\GenericSuccessResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->connectGuruRequest($guru_connect_request, $contentType);
    ...
    /**
     * Create request for operation 'connectGuru'
     *
     * @param  \Carbon\Model\GuruConnectRequest $guru_connect_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['connectGuru'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function connectGuruRequest($guru_connect_request, string $contentType = self::contentTypes['connectGuru'][0])
    {

        if ($guru_connect_request !== SENTINEL_VALUE) {
            if (!($guru_connect_request instanceof \Carbon\Model\GuruConnectRequest)) {
                if (!is_array($guru_connect_request))
                    throw new \InvalidArgumentException('"guru_connect_request" must be associative array or an instance of \Carbon\Model\GuruConnectRequest IntegrationsApi.connectGuru.');
                else
                    $guru_connect_request = new \Carbon\Model\GuruConnectRequest($guru_connect_request);
            }
        }
        // verify the required parameter 'guru_connect_request' is set
        if ($guru_connect_request === SENTINEL_VALUE || (is_array($guru_connect_request) && count($guru_connect_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter guru_connect_request when calling connectGuru'
            );
        }


        $resourcePath = '/integrations/guru';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($guru_connect_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($guru_connect_request));
            } else {
                $httpBody = $guru_connect_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  int $data_source_id data_source_id (optional)
     * @param  string $cursor cursor (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listSharepointSites'] to see the possible values for this operation
     *
     * @throws \Carbon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Carbon\Model\HTTPValidationError
    ...
    public function listSharepointSites(
        ...
        string $contentType = self::contentTypes['listSharepointSites'][0]
    )
    {

        list($response) = $this->listSharepointSitesWithHttpInfo($data_source_id, $cursor, $contentType);
        return $response;
    }

    /**
     * Operation listSharepointSitesWithHttpInfo
     *
     * List Sharepoint Sites
     *
     * List all Sharepoint sites in the connected tenant. The site names from the response can be used as the site name when connecting a Sharepoint site. If site name is null in the response, then site name should be left null when connecting to the site.  This endpoint requires an additional Sharepoint scope: \&quot;Sites.Read.All\&quot;. Include this scope along with the default Sharepoint scopes to list Sharepoint sites, connect to a site, and finally sync files from the site. The default Sharepoint scopes are: [o, p, e, n, i, d,  , o, f, f, l, i, n, e, _, a, c, c, e, s, s,  , U, s, e, r, ., R, e, a, d,  , F, i, l, e, s, ., R, e, a, d, ., A, l, l].   data_soure_id: Data source needs to be specified if you have linked multiple Sharepoint accounts cursor: Used for pagination. If next_cursor is returned in response, you need to pass it as the cursor in the next request
     ...
     * @return array of object|\Carbon\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function listSharepointSitesWithHttpInfo($data_source_id = null, $cursor = null, string $contentType = self::contentTypes['listSharepointSites'][0], \Carbon\RequestOptions $requestOptions = new \Carbon\RequestOptions())
    {
        ["request" => $request, "serializedBody" => $serializedBody] = $this->listSharepointSitesRequest($data_source_id, $cursor, $contentType);
        ...
        try {
            ...
            try {
                ...
                if (
                    ...
                    return $this->listSharepointSitesWithHttpInfo(
                        $data_source_id,
                        $cursor,
                        $contentType,
                        $requestOptions->setRetryOAuth(false)
    ...
    /**
     * Operation listSharepointSitesAsync
     *
     * List Sharepoint Sites
     *
     * List all Sharepoint sites in the connected tenant. The site names from the response can be used as the site name when connecting a Sharepoint site. If site name is null in the response, then site name should be left null when connecting to the site.  This endpoint requires an additional Sharepoint scope: \&quot;Sites.Read.All\&quot;. Include this scope along with the default Sharepoint scopes to list Sharepoint sites, connect to a site, and finally sync files from the site. The default Sharepoint scopes are: [o, p, e, n, i, d,  , o, f, f, l, i, n, e, _, a, c, c, e, s, s,  , U, s, e, r, ., R, e, a, d,  , F, i, l, e, s, ., R, e, a, d, ., A, l, l].   data_soure_id: Data source needs to be specified if you have linked multiple Sharepoint accounts cursor: Used for pagination. If next_cursor is returned in response, you need to pass it as the cursor in the next request
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSharepointSitesAsync(
        $data_source_id = SENTINEL_VALUE,
        $cursor = SENTINEL_VALUE,
    ...
    )
    {
        ...
        return $this->listSharepointSitesAsyncWithHttpInfo($data_source_id, $cursor, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listSharepointSitesAsyncWithHttpInfo
     *
     * List Sharepoint Sites
     *
     * List all Sharepoint sites in the connected tenant. The site names from the response can be used as the site name when connecting a Sharepoint site. If site name is null in the response, then site name should be left null when connecting to the site.  This endpoint requires an additional Sharepoint scope: \&quot;Sites.Read.All\&quot;. Include this scope along with the default Sharepoint scopes to list Sharepoint sites, connect to a site, and finally sync files from the site. The default Sharepoint scopes are: [o, p, e, n, i, d,  , o, f, f, l, i, n, e, _, a, c, c, e, s, s,  , U, s, e, r, ., R, e, a, d,  , F, i, l, e, s, ., R, e, a, d, ., A, l, l].   data_soure_id: Data source needs to be specified if you have linked multiple Sharepoint accounts cursor: Used for pagination. If next_cursor is returned in response, you need to pass it as the cursor in the next request
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSharepointSitesAsyncWithHttpInfo($data_source_id = null, $cursor = null, string $contentType = self::contentTypes['listSharepointSites'][0], \Carbon\RequestOptions $requestOptions = new \Carbon\RequestOptions())
    {
        $returnType = 'object';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->listSharepointSitesRequest($data_source_id, $cursor, $contentType);
    ...
    /**
     * Create request for operation 'listSharepointSites'
     *
     * @param  int $data_source_id (optional)
     * @param  string $cursor (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listSharepointSites'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listSharepointSitesRequest($data_source_id = SENTINEL_VALUE, $cursor = SENTINEL_VALUE, string $contentType = self::contentTypes['listSharepointSites'][0])
    {
        ...
        $resourcePath = '/integrations/sharepoint/sites/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
